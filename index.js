...
bot.on("callback_query:data", async (ctx) => {
  ...
  if (
    ...
    if (action === "super_calisthenics") {
      ...
      // Отправляем сообщение с основным меню
      await ctx.reply(
        "К вашему первому подтягиванию — без страхов и с учётом женской анатомии. Укрепим спину, руки, добавим уверенности. Пошаговая система от нуля до результата. Станьте сильной версией себя!",
        {
          reply_markup: new Keyboard()
            .text("📝 Записаться на курс")
            .row()
