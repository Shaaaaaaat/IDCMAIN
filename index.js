...
function getPriceAndSchedule(studio) {
  const priceSchedule = {
    ...
    calisthenics_light:
      "Стоимость онлайн-курса «Calisthenics light»:\n👉🏻 Пробный старт, 2 тренировки (доступ 4 недели)\n1900₽ | 22€\n👉🏻 12 занятий (доступ 6 недель):\n9600₽ | 108€\n👉🏻 36 занятий (доступ 14 недель):\n23400₽ | 252€",
    super_calisthenics:
      "Стоимость онлайн-курса «Super Calisthenics»:\n👉🏻 12 занятий (доступ 6 недель):\n9600₽ | 108€\n👉🏻 36 занятий (доступ 14 недель):\n23400₽ | 252€\n👉🏻 Пробная тренировка (тест-силы)\n950₽ | 11€",
    pullups_for_ladies:
      "Стоимость онлайн-курса «Подтягивания для девушек: от 0 до 1»:\n👉🏻 12 занятий (доступ 6 недель):\n9600₽ | 108€\n👉🏻 36 занятий (доступ 14 недель):\n23400₽ | 252€\n👉🏻 Пробная тренировка (тест-силы)\n950₽ | 11€",
    handstand:
...
bot.on("callback_query:data", async (ctx) => {
  ...
  if (
    ...
    if (action === "super_calisthenics") {
      ...
      // Отправляем сообщение с основным меню
      await ctx.reply(
        "Наш флагманский курс — Super Calisthenics — это инновационный онлайн-курс, где тренировки адаптируются под ваш уровень физической подготовки и цели.\nВоспользуйтесь нижним меню, чтобы выбрать нужную команду.",
        {
          reply_markup: new Keyboard()
      ...
      // Отправляем сообщение с основным меню
      await ctx.reply(
        "Наш флагманский курс — Calisthenics light — это персональный онлайн-курс, в котором программа полностью адаптируется под ваш уровень и цели.\nТренировки по 30 минут, без оборудования — идеально для старта и возвращения в форму.\nЧтобы начать, просто выберите нужную команду в нижнем меню.",
        {
          reply_markup: new Keyboard()
            .text("📝 Записаться на курс")
            .row()
      ...
      // Отправляем сообщение с основным меню
      await ctx.reply(
        "Идеальный курс для девушек, чтобы развить силу и научиться подтягиваться, где тренировки адаптируются под ваш уровень физической подготовки и цели. Курс также включает упражнения для освоения техники стойки на руках.\nВоспользуйтесь нижним меню, чтобы выбрать нужную команду.",
        {
          reply_markup: new Keyboard()
            .text("📝 Записаться на курс")
            .row()
